...
font-weight: 700;
color: #1a1a1a;
border-bottom: 3px solid #c61da2;
padding-bottom: 6px;
margin-bottom: 1rem;
...
font-weight: 600;
border-bottom: 1px solid rgba(198, 29, 162, 0.4);
...
margin-top: 0.5rem;
padding-left: 1rem;
border-left: 2px dashed #f2c9e8;
font-size: 0.92rem;
color: #4a4a4a;
}
.timeline-sub .timeline-year {
font-size: 0.72rem;
display: inline;
text-transform: none;
margin-right: 0.3rem;
